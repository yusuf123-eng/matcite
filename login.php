    ...
    <div class="container">
      <div class="row no-gutters d-flex align-items-center align-items-stretch">
        <div class="col-md-4 d-flex align-items-center py-4">
          <a class="navbar-brand" href="index.html">Matcite <span style="color:#1eaaf1;">Edu</span></a>
        </div>
    ...
    <div class="container d-flex align-items-center">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav mr-auto" id="color">
          ...
          <li class="nav-item"><a style="color: rgb(255, 255, 255, 0.7) !important;" href="register.php"
            class="nav-link" title="contact page">Register</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="ftco-section contact-section">
    <div class="container">
      <div class="row contact-info justify-content-center">
        ...
        <?php include 'files/loginError.php' ?>
            <form action="files/loginConfig.php" method="POST">
                <div class="form-group">
                    <label for="email">Email address</label>
                    <input type="email" class="form-control" name="email" aria-describedby="email" placeholder="Enter email" required>
                    <small id="emailNote" class="form-text text-muted">Your Email is kept safe from third parties !</small>
                </div>
                <div class="form-group">
